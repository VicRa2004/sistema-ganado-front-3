...
import { createRaceService } from "@/modules/race/application/RaceService";
import { AxiosRaceRepository } from "@/modules/race/infrastructure/repositories/AxiosRaceRepository";
...
const raceRepository = new AxiosRaceRepository();
...
const raceService = createRaceService(raceRepository);
